    ...
    <div>
        <el-card class="box-card link_message" >
            ...
            <div>
              ...
              <h6>申请格式：</h6>
              <p  style="font-size: 13px;">友链标题：饮亿杯JAVA</p>
              <p  style="font-size: 13px;">友链地址：饮亿杯JAVA</p>
              <p  style="font-size: 13px;">图片地址：饮亿杯JAVA</p>
            </div>
         </el-card>
                 ...
                 <a :href="item.linkAddress" >
                  <el-card shadow="hover" >
                    <el-row :gutter="15">
                        ...
                        <el-col :span="19">
                        <div>
                            <p style="font-size: 20px;line-height: 1; font-weight:bold;">{{item.linkName}}
                            </p>
                            <a @click="jump(item.linkAddress)">
                            {{item.linkAddress}}
                            </a>
  ...
  methods:{
    initLinks(){
        ...
        this.axios.get('/links/getAllLink').then(resp=>{
            console.log(resp)
            _this.BlogLinks = resp.data.data
